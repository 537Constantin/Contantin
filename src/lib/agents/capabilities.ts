...
export const capabilities: Capability[] = [
  ...
  {
    id: "phone_pickup",
    name: "Telefonannahme mit Voice-AI",
    description:
      "Nimmt eingehende Anrufe entgegen, transkribiert live und leitet intelligent weiter oder bucht Termine.",
    category: "communication",
    ownerRole: "secretary",
    requiredIntegrations: ["twilio", "elevenlabs", "deepgram", "openai"],
    permissions: ["make_calls"],
    trigger: "event",
    output: "Gesprächsprotokoll, Termin gebucht oder Rückruf geplant.",
    setup: [
      {
        key: "number",
        title: "Telefonnummer & Begrüßung",
        inputs: [
          {
            key: "phoneNumber",
            label: "Twilio-Nummer",
          ...
          },
          {
            ...
            type: "textarea",
            placeholder: "Schön, dass Sie anrufen, hier ist Aria von …",
            required: true,
          },
        ],
      },
